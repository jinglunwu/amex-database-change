CREATE OR REPLACE FUNCTION staging.agency_click_unique_cell_transform()
 RETURNS integer
 LANGUAGE plpgsql
AS $function$
DECLARE r_row_count int8;
BEGIN	
	TRUNCATE TABLE staging.agency_click_unique_cell_based;	
	
	INSERT INTO staging.agency_click_unique_cell_based
